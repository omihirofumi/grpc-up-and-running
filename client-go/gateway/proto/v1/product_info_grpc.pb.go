...
const (
	ProductInfo_AddProduct_FullMethodName = "/ecommerce.v1.ProductInfo/addProduct"
	ProductInfo_GetProduct_FullMethodName = "/ecommerce.v1.ProductInfo/getProduct"
)
...
var ProductInfo_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/v1/product_info.proto",
}
